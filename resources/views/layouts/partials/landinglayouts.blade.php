<section class="text-blue body-font flex-grow" id="home">
    <div class="container mx-auto flex px-24 py-32 md:flex-row flex-col items-center">
        <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <div class="flex justify-center">
                <button class="inline-flex text-white bg-primary border-0 py-2 px-6 focus:outline-none hover:bg-secondary rounded text-lg"><a href="{{ route('login') }}">Book Now</a></button>
            </div>
        </div>
